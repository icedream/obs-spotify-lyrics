...
const (
	...
	// Raw URL to avoid relying on GitHub's ?raw=true redirect.
...
// XOR-transformed secret string and its version, preserving JSON insertion order
// to match PHP's array_key_last() semantics.
//
